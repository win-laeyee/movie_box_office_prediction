...
def create_movie_table(project_id="is3107-418809", dataset_id="movie_dataset"):
    table_id = "movie"
    schema = [
        bigquery.SchemaField("movie_id","INTEGER", "REQUIRED"),
        ...
        bigquery.SchemaField("genres","STRING", "REPEATED"),
        bigquery.SchemaField("runtime","FLOAT"),
        bigquery.SchemaField("status","STRING"),
        bigquery.SchemaField("production_companies_count","INTEGER"),
        bigquery.SchemaField("is_adult","INTEGER"),
        bigquery.SchemaField("is_adaptation","INTEGER"),
        bigquery.SchemaField("collection_id","FLOAT"),
        bigquery.SchemaField("cast1_id","FLOAT"),
        bigquery.SchemaField("cast2_id","FLOAT"),
        bigquery.SchemaField("director_id","FLOAT"),
        bigquery.SchemaField("producer_id","FLOAT"),
        bigquery.SchemaField("tmdb_popularity","FLOAT"),
