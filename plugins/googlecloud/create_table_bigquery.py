...
def create_movie_table(project_id="is3107-418809", dataset_id="movie_dataset"):
    table_id = "movie"
    schema = [
        bigquery.SchemaField("movie_id","INT64", "REQUIRED"),
        ...
        bigquery.SchemaField("is_adult","INT64"),
        bigquery.SchemaField("is_adaptation","INT64"),
        bigquery.SchemaField("collection_id","FLOAT64"),
        bigquery.SchemaField("cast1_id","FLOAT64"),
        bigquery.SchemaField("cast2_id","FLOAT64"),
        bigquery.SchemaField("director_id","FLOAT64"),
        bigquery.SchemaField("producer_id","FLOAT64"),
